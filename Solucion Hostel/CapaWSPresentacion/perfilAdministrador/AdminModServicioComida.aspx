	    ...
	    <div class="columna2">
		    <div class="ModificarDatos">			
                ...
                <div class="Casilla2-1">
			        <h4>Tipo Servicio</h4>	
                    <asp:DropDownList ID="ddlTipoServicio" CssClass="droplist" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlEmpresas_SelectedIndexChanged" ></asp:DropDownList>
			    </div>
			    <div class="Casilla2-1">
				    <h4>Precio</h4>					
				    <asp:TextBox ID="txtPrecio" runat="server" TextMode="MultiLine" CssClass="CasillaPersona"></asp:TextBox>					
			    </div>
