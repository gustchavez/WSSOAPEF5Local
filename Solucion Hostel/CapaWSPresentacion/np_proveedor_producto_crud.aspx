<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="np_proveedor_producto_crud.aspx.cs" Inherits="CapaWSPresentacion.np_proveedor_producto_crud" %>
        ...
        <div class="ModificarDatos">
          ...
          <form id="form1" runat="server">
            ...
            <div class="Casilla2-1">
                <h4>Proveedor</h4>
                <asp:DropDownList ID="ddlProveedor" runat="server" CssClass="CasillaPersona"></asp:DropDownList>
            </div>
            <div class="Casilla2-1">
                <h4>Producto</h4>
                <asp:DropDownList ID="ddlProducto" runat="server" CssClass="CasillaPersona"></asp:DropDownList>
            </div>
            <div class="Casilla2-1">
                <h4>Precio</h4>
            ...
            <br />
            <asp:GridView ID="gwListaProvProds" runat="server"></asp:GridView>
            <br />
         </form>
        </div>
    </div>
