...
function mostrar(){
	...
	var habitacion1 = document.getElementById('individual').value;
	var habitacion2 = document.getElementById('doble').value;
	var habitacion3 = document.getElementById('triple').value;
	var habitacion4 = document.getElementById('sectuple').value;
