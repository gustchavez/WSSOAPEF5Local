...
<div class="columna2">
	<div class="ModificarDatos">
			...
			<asp:DropDownList ID="txtProveedorAgregar" runat="server" CssClass="droplist">
                ...
                <br><asp:TextBox ID="TextBox4" Text="* Selecciona Nombre Empresa" runat="server" CssClass="CasillaPersona" Visible="false"></asp:TextBox>
			</div>
			<%--<div class="Casilla2-1">
			<h4>Cod. Producto</h4>	
			...
			<asp:TextBox ID="txtDetProdAgregar" runat="server" CssClass="CasillaPersona"></asp:TextBox>
                <br><asp:TextBox ID="TextBox3" Text="* Ingrese Detalle Producto" runat="server" CssClass="CasillaPersona" Visible="false"></asp:TextBox>
			</div>
			<div class="Casilla2-1">
			...
			<asp:TextBox ID="txtPrecioProdAgregar" TextMode="Number" runat="server" CssClass="CasillaPersona" Text="0"></asp:TextBox>
                <br><asp:TextBox ID="TextBox2" Text="* Ingrese Precio Producto" runat="server" CssClass="CasillaPersona" Visible="false"></asp:TextBox>
			</div>
        	<div class="Casilla2-1">
			<h4>Stock</h4>
			<asp:TextBox ID="txtStock" runat="server" Text="0" TextMode="Number" CssClass="CasillaPersona" min="0" Max="100"></asp:TextBox>
                <br><asp:TextBox ID="TextBox1" Text="* Ingrese Stock" runat="server" CssClass="CasillaPersona" Visible="false" ></asp:TextBox>
			</div>
        	<div class="Casilla2-1">
			<h4>Stock Critico</h4>
			<asp:TextBox ID="txtStockCritico" TextMode="Number" Text="0" runat="server" CssClass="CasillaPersona" min="10"></asp:TextBox>
                <br><asp:TextBox ID="TextBox0" Text="* Ingrese Stock Critico" runat="server" CssClass="CasillaPersona" Visible="false"></asp:TextBox>
			</div>
			<div class="Casilla2-1">	
	...
	<div class="ModificarDatos2">
			...
			<h4>Nombre Empresa</h4>		
                ...
                <br><asp:TextBox ID="TextBox5" Text="* Seleccione Nombre Empresa" runat="server" CssClass="CasillaPersona" Visible="false"></asp:TextBox>
			</div>
			<div class="Casilla2-1">
			<h4>Cod. Producto</h4>	
                ...
                <br><asp:TextBox ID="TextBox6" Text="* Seleccione Cod. Producto" runat="server" CssClass="CasillaPersona" Visible="false"></asp:TextBox>
			</div>
			<div class="Casilla2-1">
			<h4>Precio Producto</h4>
			<asp:TextBox ID="txtPrecioModificar" TextMode="Number" runat="server" CssClass="CasillaPersona" min ="0"></asp:TextBox>
                <br><asp:TextBox ID="TextBox7" Text="* Ingrese Precio Producto" runat="server" CssClass="CasillaPersona" Visible="false" ></asp:TextBox>
			</div>
             <div class="Casilla2-1">
			<h4>Stock</h4>
			<asp:TextBox ID="txtStockModificar" TextMode="Number" runat="server" CssClass="CasillaPersona" min ="0"></asp:TextBox>
                 <br><asp:TextBox ID="TextBox8" Text="* Ingrese Stock" runat="server" CssClass="CasillaPersona" Visible="false"></asp:TextBox>
			</div>
            <div class="Casilla2-1">
			<h4>Stock Critico</h4>
			<asp:TextBox ID="txtStockCriticoModificar" TextMode="Number" runat="server" CssClass="CasillaPersona" min ="0"></asp:TextBox>
                <br><asp:TextBox ID="TextBox9" Text="* Ingrese Stock Critico" runat="server" CssClass="CasillaPersona" Visible="false"></asp:TextBox>
			</div>
			<div class="Casilla2-1">	
