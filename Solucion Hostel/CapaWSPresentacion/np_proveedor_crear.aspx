...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder2">
	...
	<div class="ModificarDatos2">
		...
		<div class="Casilla2-2">
		<h4 style="color: red;">Contraseña</h4>	
		<asp:TextBox ID="txtConstrasena" runat="server" TextMode="Password"  CssClass="CasillaPersona"></asp:TextBox>
		</div>
		<div class="Casilla2-2">
		<h4 style="color: red;">Confirmar Contraseña</h4>	
		<asp:TextBox ID="TextBox1" runat="server" TextMode="Password"  CssClass="CasillaPersona"></asp:TextBox>
		</div>
		<div class="Casilla2-2">	
		<asp:Button ID="btnIngresar" runat="server" Text="Ingresar" OnClick="btnAceptar_Click"  CssClass="SubmitTotal"/>
		</div>
	</div>
     ...
     <div>    
        <table style="width:75%;">
            ...
            <tr>
                ...
                <td style="width:75%;"><asp:TextBox ID="txtRazonSocial" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width:25%;">Giro</td>
                <td style="width:75%;"><asp:TextBox ID="txtGiro" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width:25%;">Correo Electrónico</td>
                <td style="width:75%;"><asp:TextBox ID="txtCorreoElectronico" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width:25%;">Teléfono Empresa</td>
                <td style="width:75%;"><asp:TextBox ID="txtTelefonoEmpresa" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width:25%;">Codigo Postal</td>
                <td style="width:75%;"><asp:TextBox ID="txtCodigoPostal" runat="server"></asp:TextBox></td>
            </tr>

            <tr>
                <td style="width:25%;">Nombre Ciudad</td>
                <td style="width:75%;"><asp:TextBox ID="txtNombreCiudad" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width:25%;">Comuna</td>
                <td style="width:75%;"><asp:TextBox ID="txtComuna" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width:25%;">Calle</td>
                <td style="width:75%;"><asp:TextBox ID="txtCalle" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width:25%;">Numero</td>
                <td style="width:75%;"><asp:TextBox ID="txtNumero" runat="server" TextMode="Number"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width:25%;">Logo</td>
                <td style="width:75%;"><asp:TextBox ID="txtLogo" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width:25%;">Rut Empleado</td>
                <td style="width:75%;"><asp:TextBox ID="txtRutEmpleado" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width:25%;">Nombre Empleado</td>
                <td style="width:75%;"><asp:TextBox ID="txtNombreEmpleado" runat="server"></asp:TextBox></td>
            </tr>

            <tr>
                <td style="width:25%;">Apellido Empleado</td>
                <td style="width:75%;"><asp:TextBox ID="txtxApellidoEmpleado" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width:25%;">Fecha Nacimiento</td>
                <td style="width:75%;"><asp:TextBox ID="txtFechaNacimiento" runat="server" TextMode="Date"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width:25%;">Correo Empleado</td>
                <td style="width:75%;"><asp:TextBox ID="txtCorreoEmpleado" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width:75%;"><asp:TextBox ID="txtConstrasena" runat="server" TextMode="Password"></asp:TextBox></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width:75%;"><asp:Button ID="btnIngresar" runat="server" Text="Ingresar" Width="88px" OnClick="btnAceptar_Click" style="height: 26px" /></td>
            </tr>
        </table>    
